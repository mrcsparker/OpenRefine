 ...
 * @author Chris Parker
 */
public class JRubyEvaluableTest {

    @Test
    public void testJRubyConcurrent(){
        ...
        Evaluable eval1 = new JRubyEvaluable("a = value\nreturn a * 2");
        Long value1 = (Long) eval1.evaluate(props);

        // create some unrelated evaluable
        new JRubyEvaluable("a = value\nreturn a * 10");
    ...
    public void testJRuby(){
        ...
        Row row = new Row(2);
        row.setCell(0, new Cell("1", null));
        row.setCell(1, new Cell("one", null));
        ...
        Evaluable eval = new JRubyEvaluable("\np cells\nreturn cells");
        Object value = eval.evaluate(props);
